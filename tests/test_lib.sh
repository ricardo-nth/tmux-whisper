...
vocab_spaced_out="$(printf '%s' 'g g m l and q w e n' | dictate_lib_apply_vocab_corrections code "$cfg_tmp" | trim_nl)"
assert_eq "vocab_spaced_acronyms" "GGML and Qwen" "$vocab_spaced_out"
