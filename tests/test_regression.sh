...
assert_contains "swiftbar_inline_menu_auto_label" "$swiftbar_modes_out" "-- ✓ auto | bash="
assert_not_contains "swiftbar_inline_menu_auto_arrow_removed" "$swiftbar_modes_out" "-- ✓ auto ->"
